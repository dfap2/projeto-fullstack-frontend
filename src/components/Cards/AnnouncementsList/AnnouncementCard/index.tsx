...
const AnnouncementCard = ({ id }: IAnnouncementCard) => {
    return (
        <StyledAnnouncementCard id={id}>
            ...
            <div className="description">
                ...
                <div className="description-footer">
                    <div>
                        <span className="body-2-500 colored-footer">0 KM</span>
                        <span className="body-2-500 colored-footer">2019</span>
                    </div>
                    <span className="heading-7-500 price">R$ 00.000,00</span>
                </div>
            </div>
